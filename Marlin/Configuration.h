...
#define STRING_CONFIG_H_AUTHOR "(Xander.Customs / Sidewinder X1 / Feb-21)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Xander Customs / Sidewinder X1"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.121, 80.121, 399.778, 437.78 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27, -55, 0 }
